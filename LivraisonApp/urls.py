...
urlpatterns = [
    ...
    path( "livraisons/<int:pk>/update-row/", views.livraison_update_row, name="livraison_update_row", ),
    ...
    path( "livreur/<int:livreur_id>/livraisons/", views.livreur_livraisons, name="livreur_livraisons",),
    # Mise à jour du statut d'une livraison par le livreur (inline dans le tableau)
    path( "livreur/<int:livreur_id>/livraisons/<int:pk>/update/", views.livreur_update_statut_row,  name="livreur_update_statut_row",),
    ...
    path(
        "livreur/<int:livreur_id>/affecter/<int:livraison_id>/",
        views.livreur_affecter_livraison,
        name="livreur_affecter_livraison",
    ),
]
